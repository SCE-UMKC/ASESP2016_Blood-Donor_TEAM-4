 ...
 */
public class BloodDriveMap extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private ArrayList<String> BloodDriveNameList = new ArrayList<>();
    private ArrayList<LatLng> latlngsList = new ArrayList<>();

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_blood_drive_map);
        // m = (Button) findViewById(R.id.getLocation);
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map_blood_drive);
        ...
        if (getIntent().getExtras() != null) {
            ...
            BloodDriveNameList = getIntent().getExtras().getStringArrayList("list");
        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (LatLng point : latlngsList) {
            ...
            options.title(BloodDriveNameList.get(j));
